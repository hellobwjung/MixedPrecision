...
# def get_image(tfrecord='mit_sub10_valid_test_6000_000.tfrecords'):
def get_image(tfrecord='mit_viz_000.tfrecords'):
    ...
    for idx, e in enumerate(mylist):
        ...
        print(type(image), type(image.numpy()), image.numpy().shape)
        image = image.numpy()
        yield image
